...
Notify({
Description = "This command only works on R6";
Title = "Nameless Admin";
Duration = 7;
	...
	local RunService = game:FindService("RunService")
	   ...
	   until getPlr(Target).Character and getPlr(Target).Character:FindFirstChildOfClass("Humanoid").Health > 0 or
		   not getPlr(Target)
...
Duration = 7;
	   ...
	   repeat
		   ...
		   RunService.Heartbeat:wait()
	   until Tool.Parent ~= Character
	   NewHumanoid.WalkSpeed = 30      player.CharacterAdded:wait(1):waitForChild("HumanoidRootPart").CFrame = CF
end)
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/DigitalityScripts/roblox-scripts/main/Bring%20All'))()
		...
		cmd.add({"getmass"}, {"getmass", "Get your mass"}, function(...)
			local mass = game.Players.LocalPlayer.Character.HumanoidRootPart.AssemblyMass 
			wait();
		
			Notify({
			Description = "Your mass is " .. mass;
			Title = "Nameless Admin";
			Duration = 5;
